...
public class Deploy {
    ...
    public static final String BASE_CMD = "cmd /c mvn " +
            "-s C:\\Users\\wuzheng\\.m2\\settings.xml " +
            "deploy:deploy-file " +
            "-Durl=http://10.186.0.22:8087/repository/maven-releases " +
    ...
    public static final String repositoyfile = "C:\\Users\\wuzheng\\.m2\\repository\\com\\primeton";
    ...
    public static void main(String[] args) {
        deploy(new File(repositoyfile).listFiles());
//    if(checkArgs(args)){
